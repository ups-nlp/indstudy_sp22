...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--explore_exploit', type=float, help="Explore-exploit constant for the MCTS algorithm")
    ...
    if args.agent == 'random':
        ...
        if args.mcts_time is None:
            ...
            ai_agent = MonteAgent(env, args.mcts_time, args.mcts_depth, args.explore_exploit)
    else:
        ai_agent = RandomAgent()
    ...
    play_game(ai_agent, env, args.num_moves, "none")
